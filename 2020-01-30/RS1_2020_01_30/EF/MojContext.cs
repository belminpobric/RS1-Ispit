    ...
    public class MojContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PredajePredmet>().HasOne(x => x.Odjeljenje)
                .WithMany().OnDelete(DeleteBehavior.Restrict);
            modelBuilder.Entity<TakmicenjeStavka>().HasOne(x => x.Takmicenje)
                .WithMany().OnDelete(DeleteBehavior.Restrict);
            modelBuilder.Entity<TakmicenjeStavka>().HasOne(x => x.OdjeljenjeStavka)
                .WithMany().OnDelete(DeleteBehavior.Restrict);
        ...
        public DbSet<TakmicenjeStavka> takmicenjeStavka { get; set; }
